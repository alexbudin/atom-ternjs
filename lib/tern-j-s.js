...
MessageIds.TERN_ADD_FILES_MSG = "AddFiles";
MessageIds.TERN_UPDATE_FILE_MSG = "UpdateFile";
MessageIds.TERN_INIT_MSG = "Init";
MessageIds.TERN_JUMPTODEF_MSG = "JumptoDef";
MessageIds.TERN_COMPLETIONS_MSG = "Completions";
MessageIds.TERN_GET_FILE_MSG = "GetFile";
MessageIds.TERN_CALLED_FUNC_TYPE_MSG = "FunctionType";
MessageIds.TERN_PRIME_PUMP_MSG = "PrimePump";
MessageIds.TERN_GET_GUESSES_MSG = "GetGuesses";
MessageIds.TERN_WORKER_READY = "WorkerReady";
MessageIds.SET_CONFIG = "SetConfig";

// Message parameter constants
MessageIds.TERN_FILE_INFO_TYPE_PART = "part";
MessageIds.TERN_FILE_INFO_TYPE_FULL = "full";
MessageIds.TERN_FILE_INFO_TYPE_EMPTY = "empty";

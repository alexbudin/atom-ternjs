...
module.exports = AutocompleteView = (function(_super) {
    ...
    AutocompleteView.prototype.currentFileBlacklisted = function() {
        ...
        blacklist = atom.config.get("tern-j-s.fileBlacklist").split(",").map(function(s) {
            return s.trim();
        });
    ...
    AutocompleteView.prototype.handleEvents = function() {
        ...
        if (!atom.config.get('tern-j-s.liveCompletion')) {
    ...
    AutocompleteView.prototype.buildWordList = function() {
        ...
        process.nextTick((function(_this) {
            return function() {
                ...
                wordHash = {};
                if (atom.config.get('tern-j-s.includeCompletionsFromAllBuffers')) {
